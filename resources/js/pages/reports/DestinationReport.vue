...
import { ArrowRight, FileText, Calendar, MapPin } from 'lucide-vue-next';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'تقرير الوجهة', href: '/reports/destination' },
];
</script>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2">
                    ...
                    <h2 class="text-xl font-semibold">
                        تقرير الوجهة: {{ destination }}
                    </h2>
                </div>
                <Link href="/reports/destination">
