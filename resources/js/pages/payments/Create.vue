...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'إضافة دفعة', href: `/payments/create/${props.order.id}` },
];
    ...
    <AppLayout :breadcrumbs="breadcrumbs" :sidebar-open="false">
        <div class="space-y-6 p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold">إضافة دفعة</h1>
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div class="rounded-lg border bg-card p-6">
                    <h3 class="mb-4 text-lg font-semibold">إضافة دفعة جديدة</h3>
                    <form @submit.prevent="submitPayment" class="space-y-4">
                        <div class="space-y-2">
                            ...
                            >
                                الحد الأقصى: {{ formatAmount(remaining) }}
                            </p>
                        </div>
            ...
            >
                <h3 class="mb-4 text-lg font-semibold">الدفعات السابقة</h3>
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="border-b text-right">
                                ...
                                <th class="pb-3 font-medium">ملاحظات</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr
